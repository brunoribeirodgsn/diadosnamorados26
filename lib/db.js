...
export async function migrate() {
  ...
  try {
    await sql`ALTER TABLE map_locations ADD COLUMN IF NOT EXISTS photo_url TEXT DEFAULT ''`;
    await sql`ALTER TABLE map_locations ADD COLUMN IF NOT EXISTS photo_caption TEXT DEFAULT ''`;
    await sql`ALTER TABLE map_locations ADD COLUMN IF NOT EXISTS nickname TEXT DEFAULT ''`;
  } catch (e) {
    console.error("Colunas já existem ou erro ao adicionar colunas em map_locations:", e);
  }
}
